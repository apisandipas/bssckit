...
import { getColor, getPadding, getBorderRadius, getBorder } from '../../utils/themeFunctions';
...
const NavLink = styled(A)`
  ...
  border: ${props => getBorder(props, 'navLink', 'default')}
    ${props => getColor(props, 'navLink', 'borderColor')};
  &:hover,
  &:focus {
