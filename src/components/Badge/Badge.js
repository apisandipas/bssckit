...
const borderRadius = props => {
  if (props.pill) {
    return css`
      border-radius: ${getBorderRadius(props, 'badge', 'pill')};
    `;
  } else if (props.noRadius) {
    return css`
      border-radius: ${getBorderRadius(props, 'badge', 'noRadius')};
    `;
  }

  return css`
    border-radius: ${getBorderRadius(props, 'badge', 'default')};
  `;
};
...
const padding = props => {
  ...
  return css`
    padding: ${getPadding(props, 'badge', 'default')};
  `;
};
...
const color = props =>
  css`
    color: ${getColor(props, 'badge', 'color')};
  `;
