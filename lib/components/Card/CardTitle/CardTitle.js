...
var margin = function margin(props) {
  return props.subtitle && (0, _styledComponents.css)(_templateObject(), (0, _themeFunctions.getMargin)(props, 'cardTitle', 'subtitleTop'), (0, _themeFunctions.getMargin)(props, 'cardTitle', 'subtitleBottom'));
};

var color = function color(props) {
  return props.muted && (0, _styledComponents.css)(_templateObject2(), (0, _themeFunctions.getColor)(props, 'cardTitle', 'colorMuted'));
};

var cardTitleStyle = function cardTitleStyle() {
  return (0, _styledComponents.css)(_templateObject3(), function (props) {
    return (0, _themeFunctions.getMargin)(props, 'cardTitle', 'bottom');
  }, function (props) {
    return margin(props);
  }, function (props) {
    return color(props);
