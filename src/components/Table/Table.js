...
import { Table as BaseTable } from '../../components/Utilities/base';
...
const TableWoClass = styled(BaseTable)`
  ...
  & td {
    padding: 0.75rem;
    vertical-align: top;
    border-top: ${props => getBorder(props, 'table', 'default')}
      ${props => getColor(props, 'table', 'borderColor')};
  }
  & thead th {
    vertical-align: bottom;
    border-bottom: ${props => getBorder(props, 'table', 'bottomTop')}
      ${props => getColor(props, 'table', 'borderColor')};
  }
  & tbody + tbody {
    border-top: ${props => getBorder(props, 'table', 'bottomTop')}
      ${props => getColor(props, 'table', 'borderColor')};
  }
  & + & {
...
const Table = React.forwardRef(({ hover, className, children, ...rest }, ref) => (
  <TableWoClass
    ref={ref}
