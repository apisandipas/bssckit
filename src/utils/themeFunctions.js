...
export const makeGetter = property => (props, accessor, ...path) =>
...
export const getConcreteBreakpointSize = (props, size) => getConfigProperty(props.theme, 'breakpoints', size);
...
export const getColor = (props, accessor, ...path) => {
  const availableColors = Object.keys(defaultTheme.palette);
