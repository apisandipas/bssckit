...
themeContexts.push('transparent');
...
const border = (size, value) => {
  ...
  return css`
    border-left: ${props =>
      (props[`borderLeft${suffix}`] || props[`border${suffix}`]) && normalizeBorderValue(value)};
    border-right: ${props =>
      (props[`borderRight${suffix}`] || props[`border${suffix}`]) && normalizeBorderValue(value)};
    border-top: ${props =>
      (props[`borderTop${suffix}`] || props[`border${suffix}`]) && normalizeBorderValue(value)};
    border-bottom: ${props =>
      (props[`borderBottom${suffix}`] || props[`border${suffix}`]) && normalizeBorderValue(value)};
    ${props =>
      themeContexts.map(
        color =>
...
const rounded = size => css`
  border-top-left-radius: ${props =>
    props[`roundedTop${size}`] || props[`roundedLeft${size}`] || props[`rounded${size}`] ? '.25rem' : null};
  border-top-right-radius: ${props =>
    props[`roundedTop${size}`] || props[`roundedRight${size}`] || props[`rounded${size}`] ? '.25rem' : null};
  border-bottom-left-radius: ${props =>
    props[`roundedBottom${size}`] || props[`roundedLeft${size}`] || props[`rounded${size}`]
      ? '.25rem'
      : null};
  border-bottom-right-radius: ${props =>
    props[`roundedBottom${size}`] || props[`roundedRight${size}`] || props[`rounded${size}`]
      ? '.25rem'
      : null};
`;
...
const spacingPadding = (size, value) => {
  ...
  return css`
    padding-left: ${props =>
      (props[`pl${suffix}`] || props[`px${suffix}`] || props[`p${suffix}`]) && normalizeSpacingValue(value)};
    padding-right: ${props =>
      (props[`pr${suffix}`] || props[`px${suffix}`] || props[`p${suffix}`]) && normalizeSpacingValue(value)};
    padding-top: ${props =>
      (props[`pt${suffix}`] || props[`py${suffix}`] || props[`p${suffix}`]) && normalizeSpacingValue(value)};
    padding-bottom: ${props =>
      (props[`pb${suffix}`] || props[`py${suffix}`] || props[`p${suffix}`]) && normalizeSpacingValue(value)};
  `;
};
