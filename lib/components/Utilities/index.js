...
_consts.themeContexts.push('transparent');
/* Vertical align --------------------------------------------------------- */
...
var _float = function _float(size) {
...
var textColors = function textColors(size) {
  return (0, _styledComponents.css)(_templateObject24(), function (props) {
    return _consts.themeContexts.map(function (color) {
      return props["text".concat(size).concat((0, _functions.capitalize)(color))] && (0, _styledComponents.css)(_templateObject25(), props.theme.palette[color]);
    });
  });
};
...
var backgroundColors = function backgroundColors(size) {
  return (0, _styledComponents.css)(_templateObject26(), function (props) {
    return _consts.themeContexts.map(function (color) {
      return props["bg".concat(size).concat((0, _functions.capitalize)(color))] && (0, _styledComponents.css)(_templateObject27(), props.theme.palette[color]);
    });
  });
};
/* Borders ---------------------------------------------------------------- */
...
var border = function border(size, value) {
  ...
  return (0, _styledComponents.css)(_templateObject28(), function (props) {
    ...
    return _consts.themeContexts.map(function (color) {
      return props["border".concat(size).concat((0, _functions.capitalize)(color))] && (0, _styledComponents.css)(_templateObject29(), props.theme.palette[color]);
    });
  });
};
...
var borderColor = function borderColor(size) {
  return (0, _styledComponents.css)(_templateObject30(), function (props) {
    return _consts.themeContexts.map(function (color) {
      return props["border".concat(size).concat((0, _functions.capitalize)(color))] && (0, _styledComponents.css)(_templateObject31(), props.theme.palette[color]);
    });
  });
};
...
var makeUtilitiesForScreenSize = function makeUtilitiesForScreenSize(size) {
  return (0, _styledComponents.css)(_templateObject52(), display(size), sizing(size), _float(size), spacingMargin(size, 'Auto'), function () {
...
var Utilities = (0, _styledComponents.css)(_templateObject54(), makeUtilitiesForScreenSize(''), ['Sm', 'Md', 'Lg', 'Xl'].map(function (size) {
  return (0, _styledComponents.css)(_templateObject55(), function (props) {
    return (0, _themeFunctions.getConcreteBreakpointSize)(props, size.toLowerCase());
