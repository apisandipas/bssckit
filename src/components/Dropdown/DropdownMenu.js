...
const StyledDiv = styled(Div)`
  ...
  border: ${props => getBorder(props, 'dropdownMenu', 'default')}
    ${props => getColor(props, 'dropdownMenu', 'borderColor')};
...
class DropdownMenu extends React.Component {
  ...
  render() {
    const { children, alwaysVisible, hidden, ...rest } = this.props;

    return (
      <StyledDiv ref={this.container} hidden={!alwaysVisible && hidden} {...rest}>
        {children}
      </StyledDiv>
    );
  }
