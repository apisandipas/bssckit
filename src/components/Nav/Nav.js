...
import { Nav as BaseNav } from '../Utilities/base';
import defaultTheme from '../../theme';
import { getColor, getPadding, getMargin, getBorder, getBreakpointSize } from '../../utils/themeFunctions';
  ...
  if (
    ...
    return css`
      @media (max-width: ${getBreakpointSize(props)}) {
        ...
        & > a {
          padding-right: ${getPadding(props, 'nav', 'collapsNoteHiddenARight')};
          padding-left: ${getPadding(props, 'nav', 'collapsNoteHiddenALeft')};
          flex: 1;
          text-align: left;
        }
      }
